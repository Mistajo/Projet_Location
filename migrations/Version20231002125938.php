 ...
 */
final class Version20231002125938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD vehicle_id INT DEFAULT NULL, CHANGE is_activated is_activated TINYINT(1) DEFAULT 1 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP vehicle_id, CHANGE is_activated is_activated TINYINT(1) NOT NULL');
    }
}
